...
function buildJsClient(Client) {
	...
	CoClient.prototype.connectPromise = function() {
	...
	CoClient.prototype.queryPromise = function() {
		var args = Array.prototype.slice.call(arguments);
		var self = this;
		return new Promise(function(resolve, reject) {
...
function buildNativeCoClientBuilder(clientBuilder) {
	return function nativeCoClientBuilder(config) {
		...
		connection.connectPromise = function() {
			var args = Array.prototype.slice.call(arguments);
			var self = this;
			return new Promise(function(resolve, reject) {
				args.push(function(err, client, done) {
				...
				connection.connect.apply(self, args);
			});
		};
		connection.queryPromise = function() {
			var args = Array.prototype.slice.call(arguments);
			var self = this;
			return new Promise(function(resolve, reject) {
				args.push(function(err, result) {
				...
				connection.query.apply(self, args);
			});
		};
		return connection;
	};
